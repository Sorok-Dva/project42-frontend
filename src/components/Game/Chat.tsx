...
export const emotes: Emote[] = [
  ...
  { code: ':_marvin', path: '/assets/images/emotes/marvin2.png', name: 'Marvin' },
  ...
  { code: ':fakenews', path: '/assets/images/emotes/fakenews.gif', name: 'Fake News' },
  { code: ':truenews', path: '/assets/images/emotes/truenews.gif', name: 'True News' },
