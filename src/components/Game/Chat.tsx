...
export const emotes: Emote[] = [
  ...
  { code: ':marvin', path: '/assets/images/emotes/marvin.png', name: 'Marvin' },
  { code: ':marvin2', path: '/assets/images/emotes/marvin2.png', name: 'Marvin' },
  { code: ':42', path: '/assets/images/emotes/42underline.png', name: '42' },
  { code: ':non', path: '/assets/images/emotes/cestNon.png', name: 'C\'est non' },
  { code: ':facepalm', path: '/assets/images/emotes/facepalm.png', name: 'Facepalm' },
  { code: '<3', path: '/assets/images/emotes/c.png', name: 'Coeur' },
  { code: ':keur', path: '/assets/images/emotes/keur.png', name: 'Keur' },
  { code: ':fakenews', path: '/assets/images/emotes/fakenews.png', name: 'Fake News' },
  { code: ':truenews', path: '/assets/images/emotes/truenews.png', name: 'True News' },
  { code: ':trollface', path: '/assets/images/emotes/trollface.png', name: 'Troll face' },
  { code: ':smart', path: '/assets/images/emotes/smart.png', name: 'Smart' },
  { code: ':wat', path: '/assets/images/emotes/wat.png', name: 'Wat' },
  { code: ':sueur', path: '/assets/images/emotes/sueur.png', name: 'Sueur' },
  { code: ':thonk', path: '/assets/images/emotes/thonk.png', name: 'Thonk' },
