...
const transactions = [
  ...
  },
  {
    id: 3,
    type: 'gift_sent',
    item: 'Cadeau: 500 Crédits',
    amount: 0,
    credits: -500,
    recipient: 'CosmicPlayer42',
    date: '2023-04-05T18:45:00Z',
    status: 'completed',
  },
  {
    id: 4,
    type: 'gift_received',
    item: 'Cadeau: Premium (1 mois)',
    amount: 0,
    credits: 0,
    sender: 'GalacticHero99',
...
// Credit packs
const creditPacks = [
  { id: 1, credits: 500, price: 4.99, bonus: 0, popular: false },
  { id: 2, credits: 1000, price: 9.99, bonus: 50, popular: false },
  { id: 3, credits: 2500, price: 19.99, bonus: 250, popular: true },
  { id: 4, credits: 5000, price: 39.99, bonus: 750, popular: false },
  { id: 5, credits: 10000, price: 79.99, bonus: 2000, popular: false },
]

// Premium plans
const premiumPlans = [
  { id: 1, name: '1 Mois', price: 4.99, credits: 500, popular: false },
  { id: 2, name: '3 Mois', price: 14.99, credits: 1500, popular: true, discount: '11%' },
  { id: 3, name: '12 Mois', price: 49.99, credits: 6000, popular: false, discount: '33%' },
]
...
const premiumBenefits = [
  {
    id: 1,
    title: 'Accès aux Zones Premium',
    description: 'Explorez des zones exclusives de la station spatiale avec des missions et récompenses uniques.',
    icon: 'map',
  },
  {
    id: 2,
    title: 'Personnages Exclusifs',
    description: 'Débloquez des personnages légendaires avec des capacités spéciales.',
    icon: 'users',
  },
  {
    id: 3,
    title: 'Cosmétiques Rares',
    description: 'Accédez à une collection de cosmétiques rares et légendaires pour personnaliser votre avatar.',
    icon: 'sparkles',
  },
  {
    id: 4,
    title: 'Bonus de Crédits',
    description: 'Recevez 10% de crédits supplémentaires sur toutes les missions et activités.',
    icon: 'trending-up',
  },
  {
    id: 5,
                ...
                >
                  ...
                  <div className="p-6 flex flex-col h-full">
                    ...
                    <div className="flex items-baseline mb-4">
                      ...
                      {plan.discount && <Badge className="ml-2 bg-green-500">-{plan.discount}</Badge>}
                    </div>
                    ...
                    <tr key={transaction.id} className="hover:bg-gray-700/30">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        ...
                        {transaction.type === 'gift_sent' && (
                          <div className="text-xs text-gray-400">Envoyé à {transaction.recipient}</div>
                        )}
                        {transaction.type === 'gift_received' && (
                          <div className="text-xs text-gray-400">Reçu de {transaction.sender}</div>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        <span
                          className={
                            transaction.credits > 0 ? 'text-green-400' : transaction.credits < 0 ? 'text-red-400' : ''
                          }
                        >
