...
const LandingPage: React.FC = () => {
  return (
    <>
      <motion.div className="relative min-h-screen overflow-hidden bg-black bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/20 via-black to-black text-white">
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-blue-500/10 mix-blend-overlay rounded-full blur-xl"></div>
          </motion.div>
        </div>
