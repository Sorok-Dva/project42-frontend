      ...
      >
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-2 bg-gray-800/50 backdrop-blur-sm rounded-lg px-4 py-2 border border-indigo-500/30">
            <div className="flex items-center">
              ...
              <span className="ml-2 font-bold text-white">1,250</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 font-bold text-white">Actif</span>
            </div>
          </div>
        </div>
        ...
        <Tabs defaultValue="shop" value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className="relative mb-8">
            ...
            <TabsList className="relative grid w-full grid-cols-2 bg-gray-800/50 backdrop-blur-sm border border-indigo-500/30 rounded-lg h-14">
              <TabsTrigger
                value="shop"
              ...
              >
                <span className="flex items-center">
                  <svg
                    ...
                    strokeWidth="2"
                  >
                    <path d="M20 7h-7.5M20 11h-7.5M20 15h-7.5M8.5 17l-5-5 5-5" />
                  </svg>
                  Boutique d'Items
                </span>
              </TabsTrigger>
